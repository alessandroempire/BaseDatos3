...
|   3 |    SORT GROUP BY                  |                 |     1 |   115 |   
165   (0)| 00:00:02 |                                                           
                                                                                
|*  4 |     HASH JOIN ANTI                |                 |   178 | 20470 |   
165   (0)| 00:00:02 |                                                           
                                                                                
|   5 |      NESTED LOOPS                 |                 |   188 |  8836 |   
107   (0)| 00:00:02 |                                                           
...
|*  9 |          BITMAP INDEX SINGLE VALUE| P_TYPE_IDX      |       |       |   
         |          |                                                           
                                                                                
|* 10 |          BITMAP INDEX SINGLE VALUE| P_BRAND_IDX     |       |       |   
         |          |                                                           
                                                                                
|* 11 |       INDEX RANGE SCAN            | PK_PARTSUPPLIER |     4 |    36 |   
  2   (0)| 00:00:01 |                                                           
                                                                                
|* 12 |      TABLE ACCESS FULL            | SUPPLIER        |   500 | 34000 |   
 58   (0)| 00:00:01 |                                                           
...
---------------------------------------------------                             
   ...
   9 - access("P_TYPE"='STANDARD PLATED COPPER')                                
  10 - access("P_BRAND"='Brand#51')                                             
  11 - access("P_PARTKEY"="PS_PARTKEY")                                         
  12 - filter("S_COMMENT" LIKE '%Customer%Complaints')                          
...
|*  3 |    HASH JOIN                          |                  |   139 | 11954
 |  1034   (1)| 00:00:13 |                                                      
                                                                                
|*  4 |     TABLE ACCESS FULL                 | REGION           |     1 |    29
 |     2   (0)| 00:00:01 |                                                      
                                                                                
|*  5 |     HASH JOIN                         |                  |   695 | 39615
 |  1032   (1)| 00:00:13 |                                                      
                                                                                
|   6 |      TABLE ACCESS FULL                | NATION           |    25 |   150
 |     2   (0)| 00:00:01 |                                                      
                                                                                
|*  7 |      HASH JOIN                        |                  |   695 | 35445
 |  1029   (1)| 00:00:13 |                                                      
                                                                                
|   8 |       NESTED LOOPS                    |                  |       |      
 |            |          |                                                      
                                                                                
|   9 |        NESTED LOOPS                   |                  |   695 | 30580
 |   971   (1)| 00:00:12 |                                                      
                                                                                
|* 10 |         VIEW                          | index$_join$_006 |   175 |  5250
 |   446   (2)| 00:00:06 |                                                      
...
|  13 |            BITMAP CONVERSION TO ROWIDS|                  |   175 |  5250
 |     1   (0)| 00:00:01 |                                                      
                                                                                
|* 14 |             BITMAP INDEX SINGLE VALUE | P_SIZE_IDX       |       |      
 |            |          |                                                      
                                                                                
|  15 |            INDEX FAST FULL SCAN       | PK_PART          |   175 |  5250
 |   470   (1)| 00:00:06 |                                                      
                                                                                
|  16 |           BITMAP CONVERSION TO ROWIDS |                  |   175 |  5250
 |    64   (0)| 00:00:01 |                                                      
                                                                                
|* 17 |            BITMAP INDEX FULL SCAN     | P_TYPE_IDX       |       |      
 |            |          |                                                      
                                                                                
|* 18 |         INDEX RANGE SCAN              | PK_PARTSUPPLIER  |     4 |      
 |     2   (0)| 00:00:01 |                                                      
                                                                                
|  19 |        TABLE ACCESS BY INDEX ROWID    | PARTSUPPLIER     |     4 |    56
 |     3   (0)| 00:00:01 |                                                      
                                                                                
|  20 |       TABLE ACCESS FULL               | SUPPLIER         | 10000 | 70000
 |    58   (0)| 00:00:01 |                                                      
                                                                                
|  21 |    SORT AGGREGATE                     |                  |     1 |    10
 |            |          |                                                      
                                                                                
|  22 |     TABLE ACCESS BY INDEX ROWID       | PARTSUPPLIER     |     4 |    40
 |     4   (0)| 00:00:01 |                                                      
                                                                                
|* 23 |      INDEX RANGE SCAN                 | PK_PARTSUPPLIER  |     4 |      
 |     3   (0)| 00:00:01 |                                                      
...
IER" "I" WHERE                                                                  
  ...
  14 - access("P_SIZE"=6)                                                       
  17 - filter("P_TYPE" LIKE '%PROMO PLATED STEEL')                              
  18 - access("PS_PARTKEY"="P_PARTKEY")                                         
  23 - access("I"."PS_PARTKEY"=:B1)                                             
