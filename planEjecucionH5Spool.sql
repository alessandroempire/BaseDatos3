...
|   3 |    SORT GROUP BY                 |                 |     1 |   115 |   204   (1)| 
00:00:03 |                                                                                
                                                                                          
|*  4 |     HASH JOIN ANTI               |                 |   178 | 20470 |   204   (1)| 
00:00:03 |                                                                                
                                                                                          
|   5 |      NESTED LOOPS                |                 |   188 |  8836 |   145   (0)| 
00:00:02 |                                                                                
                                                                                          
|   6 |       TABLE ACCESS BY INDEX ROWID| PART            |    47 |  1786 |    51   (0)| 
00:00:01 |                                                                                
                                                                                          
|*  7 |        INDEX RANGE SCAN          | P_COMPUESTOB    |    47 |       |     3   (0)| 
00:00:01 |                                                                                
                                                                                          
|*  8 |       INDEX RANGE SCAN           | PK_PARTSUPPLIER |     4 |    36 |     2   (0)| 
00:00:01 |                                                                                
                                                                                          
|*  9 |      TABLE ACCESS FULL           | SUPPLIER        |   500 | 34000 |    58   (0)| 
00:00:01 |                                                                                
...
|   0 | SELECT STATEMENT                    |                 |     1 |    86 |  2039   (1
)| 00:00:25 |                                                                             
...
|*  3 |    HASH JOIN                        |                 |   139 | 11954 |  1761   (1
)| 00:00:22 |                                                                             
                                                                                          
|   4 |     TABLE ACCESS FULL               | NATION          |    25 |   150 |     2   (0
)| 00:00:01 |                                                                             
                                                                                          
|*  5 |     HASH JOIN                       |                 |   695 | 55600 |  1759   (1
)| 00:00:22 |                                                                             
                                                                                          
|   6 |      NESTED LOOPS                   |                 |       |       |           
 |          |                                                                             
                                                                                          
|   7 |       NESTED LOOPS                  |                 |   695 | 50735 |  1700   (1
)| 00:00:21 |                                                                             
                                                                                          
|   8 |        MERGE JOIN CARTESIAN         |                 |   175 | 10325 |  1175   (1
)| 00:00:15 |                                                                             
                                                                                          
|*  9 |         TABLE ACCESS FULL           | REGION          |     1 |    29 |     2   (0
)| 00:00:01 |                                                                             
                                                                                          
|  10 |         BUFFER SORT                 |                 |   175 |  5250 |  1173   (1
)| 00:00:15 |                                                                             
                                                                                          
|  11 |          TABLE ACCESS BY INDEX ROWID| PART            |   175 |  5250 |  1173   (1
)| 00:00:15 |                                                                             
                                                                                          
|* 12 |           INDEX FULL SCAN           | P_COMPUESTOA    |   175 |       |   998   (1
)| 00:00:12 |                                                                             
...
HERE                                                                                      
  ...
  12 - access("P_SIZE"=6)                                                                 
       filter("P_SIZE"=6 AND "P_TYPE" LIKE '%PROMO PLATED STEEL')                         
